...
def test_fifo_satu_batch_penuh(db):
    ...
    db.execute(text("INSERT INTO produk_batch (produk_id, qty_sisa, harga_beli, tanggal_masuk) VALUES (1, 10, 1000, '2023-01-01')"))
    db.commit()
...
def test_fifo_lintas_dua_batch(db):
    ...
    db.execute(text("INSERT INTO produk_batch (produk_id, qty_sisa, harga_beli, tanggal_masuk) VALUES (1, 5, 800, '2023-01-01')"))
    # Batch baru: 10 qty @ 1200
    db.execute(text("INSERT INTO produk_batch (produk_id, qty_sisa, harga_beli, tanggal_masuk) VALUES (1, 10, 1200, '2023-02-01')"))
    db.commit()
...
def test_fifo_lintas_tiga_batch(db):
    ...
    db.execute(text("INSERT INTO produk (id, kode, nama, harga_beli, harga_jual) VALUES (1,'P01','Produk A',1000,2000)"))
    db.execute(text("INSERT INTO produk_batch (produk_id, qty_sisa, harga_beli, tanggal_masuk) VALUES (1, 3, 500, '2022-01-01')"))
    db.execute(text("INSERT INTO produk_batch (produk_id, qty_sisa, harga_beli, tanggal_masuk) VALUES (1, 4, 700, '2022-06-01')"))
    db.execute(text("INSERT INTO produk_batch (produk_id, qty_sisa, harga_beli, tanggal_masuk) VALUES (1, 5, 1000, '2023-01-01')"))
    db.commit()
